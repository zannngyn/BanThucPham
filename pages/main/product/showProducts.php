      ...
      <div class="container-fluid col-lg-10">
        ...
        <div>
          <form action="" method="POST">
            <ul class="nav">
              <li class="nav-item mr-2 mb-2"><p class="btn btn-light">Sắp sếp theo:</p></li>
              <li class="nav-item mr-2 mb-2"><input class="btn btn-light" type="submit" value="Bán chạy" name="hot"></li>
              <li class="nav-item mr-2 mb-2"><input class="btn btn-light" type="submit" value="Giá giảm dần" name="desc"></li>
              <li class="nav-item mr-2 mb-2"><input class="btn btn-light" type="submit" value="Giá tăng dần" name="asc"></li>
              <li class="nav-item mr-2 mb-2"><input class="btn btn-light" type="submit" value="Giảm giá nhiều nhất" name="saleoff"></li>
            </ul>
          </form>
        </div>
        ...
        ?>
            ...
            <a class="text-dark" href="index.php?navigate=showProducts&trang=<?php echo $i ?>"><?php echo $i ?></a>
            </li>
					<?php
					} 
					?>

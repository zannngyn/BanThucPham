<?php 
// Truy vấn để lấy danh sách các danh mục sản phẩm, sắp xếp theo ID_DanhMuc giảm dần
$sql_DanhMuc = "SELECT * FROM danhmuc ORDER BY ID_DanhMuc DESC";
$query_DanhMuc = mysqli_query($mysqli, $sql_DanhMuc);

// Truy vấn để lấy danh sách các nhà cung cấp, sắp xếp theo ID_NCC giảm dần
